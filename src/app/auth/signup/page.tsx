...
export default function SignupPage() {
  ...
  useEffect(() => {
    setPhoneValid(phoneNo === "" ? null : validatePhone(phoneNo));
  }, [phoneNo]);
  ...
  return (
    <div className="relative min-h-screen bg-[#f9f9f9] flex flex-col items-center justify-center overflow-hidden">
      <div className="top-0 mx-auto mb-8">
        <Image src="/PgBee.png" alt="PgBee Logo" width={120} height={50} />
      </div>

      <form
        onSubmit={handleSubmit}
        className="w-full max-w-md p-6 bg-white rounded-xl shadow-xl z-10"
      >
        ...
        <div className="mb-4">
          ...
          <input
            ...
            className={`w-full px-4 py-2 border ${
              ...
              phoneValid === false ? "focus:ring-red-500" : "focus:ring-black"
            }`}
            value={phoneNo}
